...
Tuân theo hướng dẫn chiều sâu và phạm vi phân tích đi kèm gói bằng chứng. Giải thích cơ chế và ý nghĩa ở mức nguồn hỗ trợ, phân biệt các ý thay vì chỉ liệt kê hoặc lặp lại. Chỉ xử lý những phần người dùng hỏi; nêu rõ giới hạn cho phần chưa đủ bằng chứng.
...
VIEWPOINT_CONTRACT = """viewpoint_annotations chỉ đánh dấu những đoạn trích/nhận định cụ thể, không đánh dấu toàn bộ nguồn là quan điểm. Các sự kiện trung lập khác trong cùng nguồn chỉ cần trích dẫn [S#], không cần thêm 'theo...' vào mọi câu. Lời trích trực tiếp và diễn giải một quan điểm riêng đều cần quy thuộc, dù diễn giải không dùng dấu ngoặc kép. Tên chính sách trong dấu ngoặc kép không tự động là nhận định. Không biến ý kiến riêng thành đồng thuận lịch sử. Với câu hỏi phân tích chung, ưu tiên tổng hợp sự kiện trung lập được nhiều nguồn hỗ trợ và trích các nguồn trung lập đó, không sao chép lời trích khi không cần thiết. Nguồn historiography chỉ bổ sung cách diễn giải, không thay thế bằng chứng sự kiện. Khi attribution_hint nêu tên người cụ thể, phải ghi đúng tên đó; không thay bằng "một số học giả" hay "theo nhận định" chung chung. Khi attribution_hint là null, bỏ nhận định hoặc thay bằng sự kiện có bằng chứng trung lập; không đoán người nói. Có thể bỏ hoàn toàn nhận định không cần thiết."""
