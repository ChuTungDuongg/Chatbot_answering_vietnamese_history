...
class CentralAgentConfig:
    ...
    focused_coverage_support_threshold: int = 3
    focused_coverage_min_dimensions: int = 2
    ...
    def __post_init__(self) -> None:
        ...
        if not 1 <= self.focused_coverage_min_dimensions <= self.focused_coverage_support_threshold <= 8:
            raise ValueError("Invalid Central focused coverage thresholds.")
