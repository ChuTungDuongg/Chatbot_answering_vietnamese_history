...
- `generation.py` gọi History adapter trên shared Qwen3 backend (hoặc legacy merged baseline khi chọn rõ), parse source IDs và cho tối đa một evidence-only repair.
