...
16. **Viewpoints.** Evidence containing quotations, first-person claims or selected strong evaluative language is marked `viewpoint_sensitive`. Synthesis and repair require attribution to the source/author. Unattributed detected evaluative/first-person/quoted claims trigger validation failure. The rules are intentionally lightweight; they do not certify ideological neutrality or exhaustive quotation coverage.
